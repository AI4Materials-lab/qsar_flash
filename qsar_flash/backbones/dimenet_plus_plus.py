...
from torch_geometric.nn.models.dimenet import EmbeddingBlock, Envelope, ResidualLayer, SphericalBasisLayer
...
class BesselBasisLayer(torch.nn.Module):
    def __init__(self, num_radial, cutoff=5.0, envelope_exponent=5):
        ...
        self.freq = nn.parameter.Parameter(
...
class InteractionPPBlock(torch.nn.Module):
    ...
    def reset_parameters(self):
        ...
        for res_layer in self.layers_before_skip:
            res_layer.reset_parameters()  # type: ignore
...
class DimeNetPlusPlusBackbone(torch.nn.Module):
