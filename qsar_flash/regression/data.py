...
from qsar_flash.regression.input import GraphRegressionDatasetInput
from qsar_flash.regression.input_transform import GraphRegressionInputTransform

# Skip doctests if requirements aren't available
if not _GRAPH_TESTING:
    __doctest_skip__ = ["GraphRegressionData", "GraphRegressionData.*"]


class GraphRegressionData(DataModule):
    """The ``GraphRegressionData`` class is a :class:`~flash.core.data.data_module.DataModule` with a set of
    classmethods for loading data for graph regression."""

    input_transform_cls = GraphRegressionInputTransform
    ...
    def from_datasets(
        ...
        train_transform: INPUT_TRANSFORM_TYPE = GraphRegressionInputTransform,
        val_transform: INPUT_TRANSFORM_TYPE = GraphRegressionInputTransform,
        test_transform: INPUT_TRANSFORM_TYPE = GraphRegressionInputTransform,
        predict_transform: INPUT_TRANSFORM_TYPE = GraphRegressionInputTransform,
        input_cls: Type[Input] = GraphRegressionDatasetInput,
